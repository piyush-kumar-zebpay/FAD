...
#   Features interactive menus, git integration, and release note generation.
#
# Usage:
...
show_banner() {
    echo ""
    echo -e "${ORANGE}${BOLD}"
    echo " _______  _______  _______        ______  ___   _______  _______  _______  _______  _______  ___   _______  _______ "
    echo "|   _   ||   _   ||  __   |      |  __  \  |   | |       ||       ||       ||       ||       ||   | |       ||       |"
    echo "|  |_|  ||  |_|  || |__|__|      | |  |  | |   | |  _____||_     _||    ___||    ___||_     _||   | |   _   ||    ___|"
    echo "|       ||       ||   |          | |__|  |    |   | | |_____   |   |  |   |___ |   |___   |   |  |   | |  | |  ||   |___ "
    echo "|___|___||___|___||___|          |______/    |___| |_______|  |___|  |_______||_______|  |___|  |___| |__| |__||_______|"
